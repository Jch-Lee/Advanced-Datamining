...
for (i in 1:100) {
  x_tran <- x[set100[,1]=="tran",]
  x_vald <- x[set100[,1]=="vald",]
  x_test <- x[set100[,1]=="test",]
  
  y_tran <- y[set100[,1]=="tran"]
  y_vald <- y[set100[,1]=="vald"]
  y_test <- y[set100[,1]=="test"]
  ...
  res6_D1[15,i] <- D1_knn1_4
  res6_D2[15,i] <- D2_knn1_4
  
  res6_D1[16,i] <- D1_knn2_4
  res6_D2[16,i] <- D2_knn2_4
  ###########
  res6
}
```